...
Because there's no command-line test or build path, **Codex cannot self-verify code changes** — edits compile only when the user opens the Editor. Flag this explicitly rather than claiming a change "works."
