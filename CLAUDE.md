...
Because there is no command-line test or build path, **Claude cannot self-verify code changes**. Edits compile only when the user opens the Editor. Flag this explicitly rather than claiming a change "works."
